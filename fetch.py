#!/usr/bin/env python3
"""
Fetch coduri de reducere Huawei de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/consumer.huawei.com
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/consumer.huawei.com"
STORE_NAME = "Huawei"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Huawei de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-huawei)"
    }
    try:
