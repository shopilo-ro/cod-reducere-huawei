#!/usr/bin/env node
/**
 * Fetch coduri reducere Huawei de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/consumer.huawei.com
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/consumer.huawei.com";
const STORE_NAME  = "Huawei";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-huawei)" }
  });
